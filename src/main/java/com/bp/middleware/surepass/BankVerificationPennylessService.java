...
@Service
public class BankVerificationPennylessService {
	...
	public ResponseStructure bankVerificationPennyless(RequestModel model, HttpServletRequest servletRequest) {
				...
				if (merchantPriceModel != null && vendorPriceModel!=null && merchantPriceModel.isAccepted() ) {
					...
					if (balance.getFlag() == 1) {
						...
						if (sourceResponse.getResponseId() > 0) {
							...
							return surepassBankVerificationPennyless(model, userModel, verificationModel, vendorModel,
	...
	private ResponseStructure surepassBankVerificationPennyless(RequestModel model, EntityModel userModel,
