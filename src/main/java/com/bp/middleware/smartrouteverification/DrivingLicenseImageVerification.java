...
@Service
public class DrivingLicenseImageVerification {

	
	private final String VERIFICATION_TYPE = AppConstants.DL_IMAGE;
	...
	public ResponseStructure dlImageVerification(RequestModel model, HttpServletRequest servletRequest) {
...
//			}
			...
			return drivingLicenseImageSmartRoute(userJson, model, userModel, vendorVerifyModel);
	...
	private ResponseStructure drivingLicenseImageSmartRoute(JSONObject userJson, RequestModel model,
	...
	private ResponseStructure signDeskDrivingLicenseImageVerification(JSONObject userJson, RequestModel model,
		...
		ResponseEntity<String> clientResponse = restTemplate.postForEntity(vendorPrice.getApiLink(), entity,String.class);
