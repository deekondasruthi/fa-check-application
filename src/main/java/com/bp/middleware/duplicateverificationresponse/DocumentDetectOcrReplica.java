...
@Component
public class DocumentDetectOcrReplica {

	@Autowired
	private DuplicateUtils duplicateUtils;

	public ResponseStructure documentDetectResponse(MultipartFile model, EntityModel userModel,
		...
		reqModel.setSource("Document detect OCR Image");
