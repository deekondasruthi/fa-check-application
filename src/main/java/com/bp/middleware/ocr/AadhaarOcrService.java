...
import com.bp.middleware.duplicateverificationresponse.AadhaarOcrReplica;
...
//		String surepassResponse = AppConstants.OCR_AADHAAR;
		...
		if (status) {
			...
			JSONObject motherNameDetails = indexZeroFromList.getJSONObject("mother_name");
			...
			JSONObject aadhaarNumberDetails = indexZeroFromList.getJSONObject("aadhaar_number");

			String name = fullNameDetails.getString("value");
			String gender = genderDetails.getString("value");
			String motherName = motherNameDetails.getString("value");
			String fatherName = fatherNameDetails.getString("value");
			String dob = dobDetails.getString("value");
			String aadhaarNumber = aadhaarNumberDetails.getString("value");

			request.setSource(aadhaarNumber + " OCR");
			request.setFullName(name);
			request.setDob(dob);
			request.setClientId(clientId);
			request.setStatus("success");

			response.setSource(aadhaarNumber + " OCR");
